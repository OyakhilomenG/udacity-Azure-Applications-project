...
class Config(object):
    ...
    AUTHORITY = "https://login.microsoftonline.com/" + os.environ.get('TENANT_ID', 'common') # For multi-tenant app, else put tenant name
    # AUTHORITY = "https://login.microsoftonline.com/Enter_the_Tenant_Name_Here"

    CLIENT_ID = os.environ.get('CLIENT_ID') or 'ENTER_CLIENT_ID_HERE'

    REDIRECT_PATH = "https://my-flask-article-webapp.azurewebsites.net/getAToken"  # Used to form an absolute URL; must match to app's redirect_uri set in AAD
